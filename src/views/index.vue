<template>
    <div v-loading="loading">
        ...
        <div>
            <e-container>
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="人气景点" link="/jingdianxinxi">
                        <el-row :gutter="30">
        ...
        <div>
            <e-container>
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="地方美食" link='/difangmeishi'>
                        <el-row :gutter="30">
        ...
        <div>
            <e-container>
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="旅游线路" link="/lvyouxianlu">
                        <el-row :gutter="20">
        ...
        <div>
            <e-container>
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="旅游攻略" link="/xinwenxinxi">
